...
class Params:
    def __init__(self):
        ...
        # Results directory : 'keep_same' (default), 'delete_contents',
        # 'make_separate'
        ...
        # for add: weight = alpha*pov + (1-alpha)*energy
        ...
        # normalization of the pov and energy before multiplying in
        # pov_energy_mult
        self.weight_norm_mult = False

        # binary weight
        # makes weight 0 or 1 depending on threshold:
        self.weight_binary = False
        # threshold for determining binary value of the weight func (0.001 for
        # real good atoms)
        self.weight_th = 0.4
        ...
        # maximum distance when looking for pause to align with phrase curve lp
        # minimum
        ...
        # padding to every (except last) phrase before sending to phrase
        # extractor
        ...
        self.fix_pos_ref_func_th = 0.01
        # s after threshold for seeking peak to start phrase - if 0 then
        # threshold location
        self.fix_pos_ref_func_t = 0

        # find the last point in the ref func that is > th and don't take it
        # into account for the phrase
        self.fix_pos_ref_func_end = True
        # threshold for seeking end of utterance (smaller than at beginning)
        self.fix_pos_ref_func_end_th = 0.001
        ...
        self.fix_pos_ref_func_end_s_ext = self.fix_pos_ref_func_end_t_ext * \
            self.frame_rate   # samples
        ...
        # Trimming - for theta 0.0005-0.05 there are 98 atoms, but 16 after
        # trimming with 0.98 (22 w/ 0.99)
        ...
        self.min_res_amp = 0
        # Avoid possible deadlock when atom's position is equal with the
